	...
	<section id="sdgs">
		<div class="sdgs_wrap">
			<section class="about">
				<div class="container">
					<h1 class="title">
						<span class="en sl-txt" data-dire="top">SDGs</span>
						<span class="jp sl-txt" data-dire="top">SDGsへの取り組み</span>
					</h1>
					...
					<div class="sdgs_text">
						...
						<p>また、国際社会だけでなく中小企業にとってもSDGsは取り組むべき社会的課題です。</p>
					</div>
				</div>
			</section>
			<section class="attempt">
				<div class="container">
					...
					<p class="sdgs_text">
						...
						品質マネジメントシステム(ISO9001:2015)、環境マネジメントシステム(ISO14001:2015)、情報セキュリティマネジメントシステム(ISO/IEC27001:2013)<br>
						を統合したマネジメントシステム(IMS)を構築・運用することで、持続可能な開発目標『SDGs』に取り組んでいます。
					</p>
				</div>
			</section>
			<section class="detail">
				<div class="container">
					<h2>DSE経営方針に対して取り組むべき<br class="sp-only">具体的な内容</h2>
					<ul class="detail_list">
						<li>
							<div class="sdgs_detail_wrap">
								<span>01</span>
								<div class="title">
									<h3>顧客満足</h3>
									<p class="lead">（メーカー・パートナーが安心して取引できる信頼ある会社にする）</p>
								</div>
							</div>
							<ul class="sdgs_list">
								<li><img src="<?= $base_url ?>/assets/img/sdgs/sdgs_list09.gif" alt=""></li>
							...
							<ul class="txt_list">
								...
								<li>ＤＸ推進への積極的な取り組みによりビジネスを変革し、持続可能な社会の実現に貢献します</li>
							</ul>
						</li>
						<li>
							<div class="sdgs_detail_wrap">
								...
								<div class="title">
									<h3>従業員満足</h3>
									<p class="lead">（公平・公正で誰にでもチャンスのある職場にする）</p>
								</div>
							</div>
							<ul class="sdgs_list">
								<li><img src="<?= $base_url ?>/assets/img/sdgs/sdgs_list03.gif" alt=""></li>
							...
							<ul class="txt_list">
								...
								<li>ひとりひとりの個性や能力を尊重し、多様な人材が活躍できる職場を作ります</li>
								<li>働き方の選択肢を増やし、多様な人材の採用・定着をはかります</li>
								<li>女性が活躍できる職場環境を整備します</li>
							</ul>
						</li>
						<li>
							<div class="sdgs_detail_wrap">
								...
								<div class="title">
									<h3>環境への配慮</h3>
									<p class="lead">（Think globally, Act locally.）</p>
								</div>
							</div>
							<ul class="sdgs_list">
								<li><img src="<?= $base_url ?>/assets/img/sdgs/sdgs_list07.gif" alt=""></li>
							...
							<ul class="txt_list">
								...
								<li>ひとりひとりが環境保護の意識を持ち、生活の場である地域社会の中で考え、具体的な行動を起こしていくことで、環境保全に取り組みます</li>
							</ul>
						</li>
						<li>
							<div class="sdgs_detail_wrap">
								...
								<div class="title">
									<h3>国民生活への貢献</h3>
									<p class="lead">（社員が夢と希望を持ってチャレンジできる風土を作る）</p>
								</div>
							</div>
							<ul class="sdgs_list">
								<li><img src="<?= $base_url ?>/assets/img/sdgs/sdgs_list04.gif" alt=""></li>
							...
							<ul class="txt_list">
								...
								<li>個性や能力を尊重し、多様な人材が働きがいをもって活躍できる社会を作ります</li>
								<li>闊達な意見交換によりオープンな発想ができる企業風土を作り、持続的で発展的な未来の創造に寄与します</li>
							</ul>
						</li>
					</ul>
				</div>
