...
// 管理者のメールアドレス設定
$admin_email = "recruit@group-inc.site"; // 実際のメールアドレスに変更してください
// $admin_email = "crossclub.t21@gmail.com";

// 自動返信メールの件名
$auto_reply_subject = "株式会社クリア | 【自動返信】お問い合わせ頂きありがとうございました";

// フォームの必須項目
$required_items = ['type', 'name', 'kana', 'zip', 'address', 'tel', 'email', 'message'];
...
function send_mail($form_data)
{
	...
	$mail_body .= "応募種別: " . ($form_data['type'] === 'casual' ? 'カジュアル面談' : '採用面談') . "\n";
	...
	$subject = "株式会社クリア | メールエントリーフォームからのお問い合わせ";
