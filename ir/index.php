...
<main>
	<section id="ir">
		<div class="container">
			<h1 class="title">
				<span class="en sl-txt" data-dire="top">Investor Relations</span>
				<span class="jp sl-txt" data-dire="top">IR情報</span>
			</h1>
			<div class="pl">
				<ul id="page-link">
					<li><a href="#uriage">売上推移</a></li>
					<li><a href="#eigyo_rieki">営業利益推移</a></li>
					<li><a href="#keijo_rieki">経常利益推移</a></li>
					<li><a href="#zyun_rieki">当期純利益推移</a></li>
					<li><a href="#so_sisan">総資産推移</a></li>
					<li><a href="#zyun_sisan">純資産推移</a></li>
				</ul>
			</div>
