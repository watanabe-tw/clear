...
// $to = "t.watanabe@clear-inc.sakura.ne.jp, watanabe.t@o-skin-hair.com";
$to = "recruit@group-inc.site, sales@clear-inc.site";
...
// $from = "t.watanabe@clear-inc.sakura.ne.jp";
$from = "recruit@group-inc.site";
...
$subject = "株式会社クリア | お問い合わせフォームからのお問い合わせ";
...
$thanksPage = "$newURL/contact/thanks.php";
...
$require = array('お名前','ふりがな','郵便番号','住所','電話番号','メールアドレス','お問い合わせ内容');
...
$refrom_name = "株式会社クリア 担当者";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "株式会社クリア | お問い合わせ頂きありがとうございました。";
...
?>
<?php include('../contact_confirm.php'); ?>
<?php
}
